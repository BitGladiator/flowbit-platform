    ...
    <div style={styles.container}>
      <div style={styles.header}>
        <div style={styles.headerContent}>
          ...
          <p style={styles.subtitle}>Manage your team members and permissions</p>
        </div>
        <button 
      ...
      {showInviteForm && (
        <div style={styles.formSection}>
          <div style={styles.formHeader}>
            ...
            <p style={styles.formSubtitle}>Send an invitation to join your team</p>
          </div>
              ...
              <div key={employee._id} style={styles.employeeCard}>
                ...
                <div style={styles.employeeDetails}>
                  <div style={styles.detailRow}>
                    ...
                    <span style={{
                      ...styles.roleBadge,
                      backgroundColor: employee.role === 'Admin' ? 'rgba(239, 68, 68, 0.2)' : 'rgba(59, 130, 246, 0.2)',
                      color: employee.role === 'Admin' ? '#ef4444' : '#3b82f6',
                      border: employee.role === 'Admin' ? '1px solid rgba(239, 68, 68, 0.3)' : '1px solid rgba(59, 130, 246, 0.3)'
                    }}>
                      {employee.role === 'Admin' ? <AdminIconSmall /> : <UserIconSmall />}
                      {employee.role}
                    </span>
                  </div>
                  {employee.department && (
...
const TeamIcon = () => (
  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M23 21V19C22.9993 18.1137 22.7044 17.2528 22.1614 16.5523C21.6184 15.8519 20.8581 15.3516 20 15.13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    <path d="M16 3.13C16.8604 3.35031 17.623 3.85071 18.1676 4.55232C18.7122 5.25392 19.0078 6.11683 19.0078 7.005C19.0078 7.89318 18.7122 8.75608 18.1676 9.45769C17.623 10.1593 16.8604 10.6597 16 10.88" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
);
...
const AdminIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M19 4H5C4.44772 4 4 4.44772 4 5V19C4 19.5523 4.44772 20 5 20H19C19.5523 20 20 19.5523 20 19V5C20 4.44772 19.5523 4 19 4Z" stroke="currentColor" strokeWidth="1.5"/>
...
const InviteIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M8.5 11C10.7091 11 12.5 9.20914 12.5 7C12.5 4.79086 10.7091 3 8.5 3C6.29086 3 4.5 4.79086 4.5 7C4.5 9.20914 6.29086 11 8.5 11Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
...
const DepartmentIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M19 21H5C4.44772 21 4 20.5523 4 20V11L10 7L16 11V20C16 20.5523 15.5523 21 15 21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    <path d="M10 21V17C10 16.4477 10.4477 16 11 16H13C13.5523 16 14 16.4477 14 17V21" stroke="currentColor" strokeWidth="1.5"/>
